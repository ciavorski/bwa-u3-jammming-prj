const clientId = "d9174277b4fe412ea92d7ff935a6adef";

// const redirectUri = "http://ciavorski-jammming.surge.sh/";
...
const Spotify = {
  getAccessToken() {
    ...
    if (accessToken) {
      ...
      throw new Error("Page redirected."); // TODO: Learn how to catch errors
    }
  },

  search(term) {
    const urlWithSearchTerm = `https://api.spotify.com/v1/search?type=track&q=${term}`;
          ...
          return fetch("https://api.spotify.com/v1/me", {
            ...
            .then(
              response => {
                ...
                throw new Error("Failed to obtain UserID!");
              },
              networkError => console.log(networkError.message)
            )
            .then(jsonResponse => {
